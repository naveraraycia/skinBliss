...
function CallToAction() {
  ...
  return (
    <div className="flex flex-col md:flex-row">
      ...
      <div className={`flex justify-center px-5 py-20 ${location.pathname === '/' ? 'bg-maroon' : 'bg-pink'} md:order-1 md:w-3/5 md:px-20`}>
        <div className="max-w-[600px] flex flex-col justify-center space-y-5">
          <div className={`flex flex-col ${location.pathname === '/' ? 'text-white' : 'text-maroonDark'} justify-center items-center text-center space-y-3 md:text-left md:items-start`}>
